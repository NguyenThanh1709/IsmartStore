    ...
    <div id="content" class="container-fluid">
        <div class="card">
            <div class="card-header font-weight-bold">
                <div class="row">
                    <h5 class="m-0 col-md-8 col-xs-12">Thông tin vai trò</h5>
                </div>
            </div>
            <div class="card-body">
                {!! Form::open(['route' => ['role.update', $role->id], 'method' => 'POST', 'files' => true]) !!}
                            ...
                            <div class="row">
                                @foreach ($modulePermissions as $permission)
                                    <div class="col-md-3 pb-3">
                                        {!! Form::checkbox($permission->slug, $permission->id, in_array($permission->id, $role->permissions->pluck('id')->toArray()), [
                                            'class' => 'permission',
                                            'name' => 'permission_id[]',
                                            'id' => $permission->slug,
                                        ]) !!}
